...
/***/ (function(module, exports, __webpack_require__) {
	...
	var syy = new _lottery2.default(); //es6兼容
	...
	var Base = function () {
	   ...
	   */
			...
			value: function initNumber() {
				for (var i = 1; i < 12; i++) {
					this.number.add(('' + i).padStart(2, '0')); //号码前面补0
				}
			}
	   ...
	   */
			...
			value: function getRandom(num) {
				var arr = [],
				    index = void 0;
				var number = Array.from(this.number); //将一个集合转换成数组??
				while (num--) {
	...
	var Calculate = function () {
	   ...
	   */
			value: function computeCount(active, play_name) {
				...
				var arr = new Array(active).fill('0'); //指定长度为active,每个元素为0的数组
